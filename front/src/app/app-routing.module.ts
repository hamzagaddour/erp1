...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'bonLivraison',
        loadChildren: () => import('./comerce/livraison/livraison.module').then(module => module.LivraisonModule)
      },

      {
      path: 'parametre',
      loadChildren: () => import('./comerce/parametrelivraison/parametrelivraison.module').then(module => module.ParametrelivraisonModule)
      },
